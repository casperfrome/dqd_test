...
def _run_lightweight_migrations(connection: sqlite3.Connection) -> None:
    ...
    _ensure_column(connection, "ai_database_facts", "embedding_json", "TEXT NOT NULL DEFAULT ''")
    _ensure_column(connection, "ai_code_facts", "embedding_json", "TEXT NOT NULL DEFAULT ''")
